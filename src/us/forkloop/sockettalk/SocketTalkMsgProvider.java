...
public class SocketTalkMsgProvider extends ContentProvider {
	...
	static {
		...
		sUriMatcher.addURI(AUTHORITY, "msgs/*", 2);		// match message sender
		sUriMatcher.addURI(AUTHORITY, "msgs/#", 3);		// fetch specific message
